...
# --------------------------------------------------------
# LISTA QUE ARMAZENARÁ OS OBJETOS DA CLASSE ALUNO
# --------------------------------------------------------
...
def cadastrar_aluno():
    ...
    if aluno_existente is not None:
        print("\nERRO: já existe um aluno com esse prontuário.")
        return
